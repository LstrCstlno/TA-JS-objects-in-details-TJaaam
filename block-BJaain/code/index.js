...
myObject.someMethod(); //this = myObject{someMethod:f}
...
person.displayName.call(person2); // Pual Adams
...
obj.getThis3 = obj.getThis.bind(obj); // window
obj.getThis4 = obj.getThis2.bind(obj); // obj
...
//refference error innerItem is not defined
...
let object = {
  ...
  doubleArrow: function () {
    ...
    return this.dataDouble.map((item) => {
      console.log(this); // object,object,object
      return item * 2;
    });
  },
};
...
//because when we bind we sync the function printSecondData to obj1 hense the vaalue of this will be obj1 and when PrimtSecondData is called we should get the output from obj1
